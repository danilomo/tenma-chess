(ns tenma-chess.concurrent-test
  (:require [clojure.core.async :as a :refer [<!! <! >! go]]
            [tenma-chess.algebraic :refer [parse-pgn]]
            [tenma-chess.concurrent :refer [start-game-server! new-player get-stats]]
            [clojure.test :refer [deftest is]]))

(def pgn-game "1.e4 c5 2.Nf3 g6 3.c3 d5 4.e5 Nc6 5.Bb5 Bg4 6.d4 cxd4 7.cxd4 Qb6 8.Bxc6+ bxc6
