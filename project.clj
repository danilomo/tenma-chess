(defproject tenma-chess "0.1.0-SNAPSHOT"
  ...
  :ring {:handler tenma-chess.handler/app
         :uberwar-name "tenma-chess.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "tenma-chess.jar"
  :main tenma-chess.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "tenma-chess.core/mount-root"}
             :compiler
             {:main "tenma-chess.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
